...
stringtieMerged[1:5,]
testString<- as.vector(stringtieMerged[1:200,9])
...
uniqueMSTRG
listFormat <- lapply(1:length(uniqueMSTRG),function(x) splitStrings[match(uniqueMSTRG[x],splitStrings[,1]),])
length(listFormat) == length(uniqueMSTRG) # true
