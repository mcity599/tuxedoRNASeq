...
names(qlfSigFoldTagsDown) <- 
names(qlfSigFoldTagsUp)
...
names(EdgeR_downRegGenes) <- c("UpregulatedInNr","UpregulatedInPNT","UpregulatedInInjCap")
names(EdgeR_upRegGenes) <- c("UpregulatedInWt","UpregulatedInTbud","UpregulatedInConCap")
```
